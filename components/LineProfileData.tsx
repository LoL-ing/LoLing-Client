...
const getLineImage = (prop: string) => {
  ...
  if (prop == 'TOP') {
    ...
    result =
      'https://w.namu.la/s/7f916b343072a3f9ea7eb9ddefc3f6e3017afe24da3d0c1d039c87ce3906deb627973515e12626a9dd618d7fabee42ee9afbf3427fff1fd51a430aeb80a0a1b59131a084123a167fefee3c2ddb07dac24fe43c2c7c08aaae5015111e4f8145e2';
  } else if (prop == 'MIDDLE') {
    result =
